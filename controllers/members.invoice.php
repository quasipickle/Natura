...
class PageController extends Controller
{
	...
	public $template = 'members.invoice.tpl.php';
	...
	public function loadPastOrder($id,$id_type)
	{
		...
		{			
			...
			$OrderData->member_first_name = $Order->Member->first_name;
			$OrderData->member_last_name = $Order->Member->last_name;
			
			$this->TPL->Order = $OrderData;
		}
	}		
}
